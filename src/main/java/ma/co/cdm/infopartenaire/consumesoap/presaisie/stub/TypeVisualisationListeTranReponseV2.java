...
/**
 * <p>Classe Java pour typeVisualisationListeTranReponseV2 complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="typeVisualisationListeTranReponseV2"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="listePreSaisiesTransfert" type="{http://wspsaisi_j.webservices.natsys.fr/}typePreSaisieTransfertV2" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "typeVisualisationListeTranReponseV2", propOrder = {
    "listePreSaisiesTransfert",
    "reponse"
})
public class TypeVisualisationListeTranReponseV2 {

    protected List<TypePreSaisieTransfertV2> listePreSaisiesTransfert;
     ...
     * 
     */
    public List<TypePreSaisieTransfertV2> getListePreSaisiesTransfert() {
        if (listePreSaisiesTransfert == null) {
            listePreSaisiesTransfert = new ArrayList<TypePreSaisieTransfertV2>();
        }
